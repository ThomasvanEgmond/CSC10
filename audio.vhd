...
ARCHITECTURE Structure OF audio IS
...
BEGIN
    u0 : component week4_system
        port map (
            ...
            audio_video_SDAT       => FPGA_I2C_SDAT,       --        audio_video.SDAT
            audio_video_SCLK       => FPGA_I2C_SCLK,       --                   .SCLK
            external_audio_clk_clk => AUD_XCK  -- external_audio_clk.clk
        );
END Structure;