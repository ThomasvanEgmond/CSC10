...
module reactiespel_system_mm_interconnect_0_router_default_decode
  #(
...
module reactiespel_system_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    reactiespel_system_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x50 .. 0x58 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 19'h50  && read_transaction  ) begin
            src_channel = 8'b00001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x58 .. 0x60 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 19'h58   ) begin
