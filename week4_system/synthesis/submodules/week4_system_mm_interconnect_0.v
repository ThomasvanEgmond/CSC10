// week4_system_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module week4_system_mm_interconnect_0 (
	...
	wire  [18:0] audio_and_video_config_0_avalon_av_config_slave_agent_m0_address;                   // audio_and_video_config_0_avalon_av_config_slave_agent:m0_address -> audio_and_video_config_0_avalon_av_config_slave_translator:uav_address
	...
	wire  [97:0] audio_and_video_config_0_avalon_av_config_slave_agent_rf_source_data;               // audio_and_video_config_0_avalon_av_config_slave_agent:rf_source_data -> audio_and_video_config_0_avalon_av_config_slave_agent_rsp_fifo:in_data
	...
	wire  [97:0] audio_and_video_config_0_avalon_av_config_slave_agent_rsp_fifo_out_data;            // audio_and_video_config_0_avalon_av_config_slave_agent_rsp_fifo:out_data -> audio_and_video_config_0_avalon_av_config_slave_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // audio_and_video_config_0_avalon_av_config_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [8:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_channel
	...
	wire  [96:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> pio_leds_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // pio_leds_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> pio_leds_s1_agent:cp_channel
	...
	wire  [96:0] audio_and_video_config_0_avalon_av_config_slave_agent_rp_data;                      // audio_and_video_config_0_avalon_av_config_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [96:0] pio_leds_s1_agent_rp_data;                                                          // pio_leds_s1_agent:rp_data -> router_009:sink_data
	...
	week4_system_mm_interconnect_0_router router (
	...
	week4_system_mm_interconnect_0_router_001 router_001 (
	...
	week4_system_mm_interconnect_0_router_002 router_002 (
	...
	week4_system_mm_interconnect_0_router_002 router_003 (
	...
	week4_system_mm_interconnect_0_router_002 router_004 (
	...
	week4_system_mm_interconnect_0_router_002 router_005 (
	...
	week4_system_mm_interconnect_0_router_002 router_006 (
	...
	week4_system_mm_interconnect_0_router_007 router_007 (
	...
	week4_system_mm_interconnect_0_router_007 router_008 (
	...
	week4_system_mm_interconnect_0_router_002 router_009 (
	...
	week4_system_mm_interconnect_0_router_002 router_010 (
	...
	week4_system_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                          //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                 //        clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_mux_005 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_mux_005 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_demux_005 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_demux_005 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week4_system_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
